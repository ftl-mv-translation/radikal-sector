# RadiKal Sector Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/radikal-sector/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest RK into src-en/ directory
